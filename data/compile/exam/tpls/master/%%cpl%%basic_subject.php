...
<?php } ?>
 ...
 $sid++; ?>
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a class="btn ajax" href="index.php?exam-master-basic-clearpoint&subjectid=<?php echo $subject['subjectid']; ?>" title="更新缓存"><em class="glyphicon glyphicon-refresh"></em></a>
