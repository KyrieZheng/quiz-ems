...
<?php } ?>
 ...
 $uid++; ?>
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a class="btn confirm" msg="确定要强行收卷？" href="index.php?exam-master-basic-savepaper&token=<?php echo $user['examsessiontoken']; ?>&examsessionid=<?php echo $user['examsessionid']; ?>" title="强行收卷"><em class="glyphicon glyphicon-remove"></em></a>
                                    </div>
                                </td>
                            </tr>
                            <?php } ?>
