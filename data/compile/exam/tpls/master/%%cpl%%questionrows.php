...
<?php } ?>
 ...
 $qid++; ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo $question['qrusername']; ?><br /><?php echo date('Y-m-d',$question['qrtime']); ?>
                                        </td>
                                        <td>
                                            <?php if($question['qrdeler']){ ?><?php echo $question['qrdeler']; ?><br /><?php echo date('Y-m-d',$question['qrdeltime']); ?><?php } ?>
                                        </td>
                                        <td>
