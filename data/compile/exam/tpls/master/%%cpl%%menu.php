...
<div class="panel-group" id="panel-13465">
    ...
    <div class="panel panel-primary">
        ...
        <div id="panel-element-212076" class="panel-collapse<?php if($this->tpl_var['method'] == 'questions' || $this->tpl_var['method'] == 'rowsquestions' || $this->tpl_var['method'] == 'feedback'){ ?> in<?php } ?> collapse" role="tabpanel">
             <ul class="list-group">
                ...
                <li class="list-group-item"><a href="index.php?<?php echo $this->tpl_var['_app']; ?>-master-feedback">错题反馈</a></li>
            </ul>
        </div>
    </div>
    <div class="panel panel-primary">
    ...
    <div class="panel panel-primary">
        ...
        <div id="panel-element-2120901" class="panel-collapse<?php if($this->tpl_var['method'] == 'tools'){ ?> in<?php } ?> collapse" role="tabpanel">
             <ul class="list-group">
                <li class="list-group-item hide"><a href="index.php?<?php echo $this->tpl_var['_app']; ?>-master-tools">删除试题</a></li>
