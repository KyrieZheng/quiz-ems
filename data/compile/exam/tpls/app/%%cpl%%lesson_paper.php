...
<script type="text/javascript">
    $(document).ready(function(){
        submitAjax({url:"index.php?exam-app-lesson-ajax-questions&knowsid=<?php echo $this->tpl_var['knows']['knowsid']; ?>","target":"questionpanel"});
        ...
        $('body').delegate('.jump.badge','click',function(){
            ...
            if($number <= 0)return ;
            submitAjax({url:"index.php?exam-app-lesson-ajax-questions&knowsid=<?php echo $this->tpl_var['knows']['knowsid']; ?>&number="+$number,"target":"questionpanel"});
        });
