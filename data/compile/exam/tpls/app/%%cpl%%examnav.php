    ...
    <div class="topbar-box">
        ...
        <div class="col-xs-8">
            <ul class="list-unstyled list-inline text-right">
                ...
                <li>
                    <span class="menu">欢迎您，<?php echo $this->tpl_var['_user']['username']; ?></span>
                </li>
                <li>|</li>
                <li>
...
<div class="header">
    <div class="nav">
        ...
        <div class="col-xs-7">
            <ul class="list-unstyled list-inline">
                <li>
                    <h3 class="logo"><?php echo $this->tpl_var['data']['currentbasic']['basic']; ?></h3>
                </li>
                <li class="badge">
                    到期时间 <?php echo date('Y-m-d',$this->tpl_var['data']['currentbasic']['obendtime']); ?>
                </li>
            </ul>
        </div>
        <div class="col-xs-2">
