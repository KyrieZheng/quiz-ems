...
<?php } ?>
 ...
 $cid++; ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="index.php?content-master-contents&catid=<?php echo $content['contentcatid']; ?>" target=""><?php echo $this->tpl_var['categories'][$content['contentcatid']]['catname']; ?></a>
                                        </td>
                                        <td>
                                            <?php echo date('y-m-d',$content['contentinputtime']); ?>
                                        </td>
                                        <td>
                                            <?php echo $content['contentusername']; ?>
                                        </td>
                                        <td>
                                            <?php echo date('y-m-d',$content['contentmodifytime']); ?>
                                        </td>
                                        <td>
                                            <?php echo $content['contentmodifier']; ?>
                                        </td>
                                        <td class="actions">
                                            <div class="btn-group">
...
<script src="index.php?content-master-contents-catsmenu&catid=<?php echo $this->tpl_var['catid']; ?>"></script>
<script>
    $('#catsmenu').treeview({
