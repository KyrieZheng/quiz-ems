...
<ul class="list-unstyled list-txt">
    <li class="border<?php if($this->tpl_var['method'] == 'index'){ ?> active<?php } ?>">
        <a href="index.php?user-center">
            <span class="glyphicon glyphicon-user"></span> 个人中心
        </a>
    </li>
    <li class="border<?php if($this->tpl_var['method'] == 'progress'){ ?> active<?php } ?>">
        <a href="index.php?user-center-progress">
            <span class="glyphicon glyphicon-stats"></span> 学习进度
        </a>
    </li>
    <li  class="border<?php if($this->tpl_var['method'] == 'payfor'){ ?> active<?php } ?>">
        <a href="index.php?user-center-payfor">
            <span class="glyphicon glyphicon-yen"></span> 积分充值
        </a>
    </li>
    <li  class="border<?php if($this->tpl_var['method'] == 'privatement'){ ?> active<?php } ?>">
        <a href="index.php?user-center-privatement">
            <span class="glyphicon glyphicon-cog"></span> 个人设置
        </a>
    </li>
    <?php if($this->tpl_var['_user']['groupmoduleid'] == 1){ ?>
    <li  class="border">
    ...
    <?php } ?>
    <?php if($this->tpl_var['_user']['groupmoduleid'] == 12){ ?>
    <li  class="border">
